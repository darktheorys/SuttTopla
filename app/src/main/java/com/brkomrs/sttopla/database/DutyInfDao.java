...
/** 
 * DAO for table "duty_tbl".
*/
public class DutyInfDao extends AbstractDao<DutyInf, Long> {

    public static final String TABLENAME = "duty_tbl";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"duty_tbl\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"duty_tbl\"";
        db.execSQL(sql);
    }
