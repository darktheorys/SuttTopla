...
/** 
 * DAO for table "dbo.Farms".
*/
public class FarmInfDao extends AbstractDao<FarmInf, Long> {

    public static final String TABLENAME = "dbo.Farms";
    ...
    public static class Properties {
        ...
        public final static Property FarmName = new Property(1, String.class, "FarmName", false, "FARM_NAME");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"dbo.Farms\" (" + //
                "\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: Id
                "\"FARM_NAME\" TEXT);"); // 1: FarmName
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"dbo.Farms\"";
        db.execSQL(sql);
    }
    ...
    public FarmInf readEntity(Cursor cursor, int offset) {
        FarmInf entity = new FarmInf( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // FarmName
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, FarmInf entity, int offset) {
        ...
        entity.setFarmName(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
